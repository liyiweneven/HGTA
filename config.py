...
class Config:
    def parse_argument(self):
        ...
        parser.add_argument('--news_encoder', type=str, default='SCA',choices=['CNE', 'CNN', 'MHSA', 'KCNN', 'HDC', 'NAML', 'PNE', 'DAE', 'Inception','NAML_Title', 'NAML_Content', 'CNE_Title', 'CNE_Content', 'CNE_wo_CS', 'CNE_wo_CA','CAUM','SCA','SCA_wo_BiLSTM','SCA_wo_Threshold'], help='News encoder')
        parser.add_argument('--user_encoder', type=str, default='MULTI', choices=['SUE', 'LSTUR', 'MHSA', 'ATT', 'CATT', 'FIM', 'PUE', 'GRU', 'OMAP', 'SUE_wo_GCN', 'SUE_wo_HCA','MULTI','Candi','SCA_wo_Multi','SCA_wo_Threshold'], help='User encoder')
        ...
        parser.add_argument('--max_title_length', type=int, default=20, help='Sentence truncate length for title')#32
        parser.add_argument("--title_length", type=int, default=20)  #########
        parser.add_argument("--cnn-dim", type=int, default=128)  #########
        ...
        parser.add_argument('--epoch', type=int, default=6, help='Training epoch')#16
        ...
        self.train_root = 'D:/NNR-main/MIND-%s/train' % self.dataset
        self.dev_root = 'D:/NNR-main/MIND-%s/dev' % self.dataset
        self.test_root = 'D:/NNR-main/MIND-%s/test' % self.dataset
    ...
    def preliminary_setup(self):
        ...
        self.best_model_dir = 'D:/NNR-main/best_model/' + self.dataset + '/' + model_name
